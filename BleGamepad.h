...
#define GAMEPAD_OUTDATALEN  10
#define GAMEPAD_INPORT_LEN  18
...
public:
    uint8_t HID_Type=0;
    BleGamepad(std::string deviceName = "GamepadMPU", std::string deviceManufacturer = "Ztech", uint8_t batteryLevel = 100);
